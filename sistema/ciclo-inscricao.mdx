...
<AccordionGroup>
  <Accordion title="PENDING → AWAITING_PAYMENT" icon="credit-card">
    ...
    2. Armazena o `externalPaymentId`
  ...
  <Accordion title="AWAITING_PAYMENT → EXPIRED" icon="clock">
    ...
    - **Cartão**: conforme expiração da sessão Asaas
...
Ao expirar, o atleta pode se inscrever novamente do zero. O preço será o do **lote vigente** na nova data de inscrição — a inscrição expirada não é reativada.
